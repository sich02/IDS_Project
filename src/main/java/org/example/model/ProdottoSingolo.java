...
public class ProdottoSingolo extends Prodotto {
    ...
    public ProdottoSingolo(String nome, String descrizione, double prezzo, int quantitaDiponibile, Venditore venditore) {
        super(nome, descrizione, prezzo, quantitaDiponibile, venditore);
    }
